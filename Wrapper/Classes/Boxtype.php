...
class Boxtype extends Wrapper
{
    ...
    public function getPage($page)
    {
        if ($page >= 1)
            $this->json = Wrapper::ExecuteCurl(
                Urls::MainPath . Urls::Boxtype . "?" . http_build_query(['page' => $page]));
        return $this;
    }
    ...
    public function query(array $data)
    {
        if (!empty($data))
            $this->json = Wrapper::ExecuteCurl(
                Urls::MainPath . Urls::Boxtype . "?" . http_build_query($data));
        return $this;
    }
